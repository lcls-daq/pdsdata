...
namespace Pds
{
  ...
  public:
    ...
    { NoDetector,
      ...
      XppSb1Ipm, XppSb1Pim, XppMonPim, XppSb2Ipm, XppSb3Ipm, XppSb3Pim,
        XppSb4Pim, XppGon, XppLas, XppEndstation,
      AmoEndstation,
      CxiEndstation,
      XcsEndstation,
      MecEndstation,
    ...
    enum Device
    { NoDevice, Evr, Acqiris, Opal1000, TM6740, pnCCD, Princeton, Fccd, Ipimb,
      Encoder, Cspad, NumDevice };
